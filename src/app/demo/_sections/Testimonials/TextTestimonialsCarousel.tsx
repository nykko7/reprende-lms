        ...
        {testimonials.map(
          (
            ...
            <CarouselItem key={index}>
              <div className="group mx-auto flex h-full flex-col items-center justify-between gap-y-2 border-b-2 py-4  transition-all duration-300 ease-in hover:border-b-primary">
